    ...
    >
      <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            type="button"
            className="flex items-center justify-center py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition text-white text-sm font-medium"
            onClick={() => {
              // TODO: Implement Google Auth
              alert("Google Auth not configured yet. Please configure in Supabase.")
            }}
          >
          ...
          <button
            ...
            onClick={() => {
              ...
              alert("GitHub Auth not configured yet. Please configure in Supabase.")
            }}
          >
